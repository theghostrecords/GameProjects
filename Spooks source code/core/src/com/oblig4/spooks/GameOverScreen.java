...
public class GameOverScreen implements Screen {
	...
	public GameOverScreen(final Spooks game, final SpooksGame gamestate, Texture bckgndImage) {
		...
		// Game over and Score
	Label gameOverLabel = new Label("GAME OVER", new Label.LabelStyle(new BitmapFont(), Color.TEAL));
